...
test('franchise settings client sends scoped GET and partial Time Snap PATCH', async () => {
  ...
  await updateFranchiseSettings({ franchiseId: 77, clockInTimeSnapEnabled: true });
